...
<div class="row">
    <section class="panel">
        <header class="panel-heading text-center"><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
           Add Award
        </header>
        <div class="panel-body">
            <div class="position-center">
                <div class="col-md-12">
                    <form role="form" action="{{ route('award-update') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="form-group">
                            ...
                            <input type="text" name="award_title" class="form-control" value="{{ $award->award_title }}" required>
                            <input type="hidden" name="id" value="{{ $award->id }}" required>

                        </div> <div class="form-group">
                                <label class="control-label">Image Upload</label>
                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                    <div class="fileupload-new thumbnail" style="width: 276px; height: 256px;">
                                        <img src="{{ asset('') }}{{ $award->award_image }}">
                                    </div>
                                    ...
                                    <div>
                                                   ...
                                                   <input type="file" class="default" name="award_image" accept="image/*"/>
                                                   <input type="hidden" name="award_image_update" value="{{ $award->award_image }}">
                                                   </span>
                        ...
                        <div class="form-group">
                                                ...
                                                <textarea class="form-control ckeditor" name="description" placeholder="Some Description" required>{{ $award->description }}</textarea>
                            </div>
                            <div class="form-group">
                            <label>Image Position</label>
                            <div class="single-row">
                                <input tabindex="3" type="radio" value="1" name="image_position" checked> Right
                                <input tabindex="3" type="radio" value="0" name="image_position"> Left
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Publication Status</label>
                            <div class="single-row">
                                <input tabindex="3" type="radio" value="1" name="publication_status" checked> Publish
