    ...
    <div class="row">
            <section class="panel">
                ...
                <div class="panel-body">
                        <form role="form" action="{{ route('blog-update') }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="col-md-9">
                            <div class="form-group">

                                <label>Title</label>
                                <input type="hidden" class="form-control" name="id" value="{{ $blogDetail->id }}">
                                <input type="text" class="form-control" name="title" value="{{ $blogDetail->title }}" placeholder="Give a short title for this blog." maxlength="100">

                            </div>
                             <div class="form-group">

                                <label>Blog Slug ( Don't use any space )</label>
                                <input type="text" class="form-control" name="blog_slug" value="{{ $blogDetail->blog_slug }}" placeholder="Don't use any space" maxlength="100">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="short_description" rows="2" placeholder="Short Description"
                                              maxlength="200">{{ $blogDetail->short_description }}</textarea>

                                </div>
                            <div class="form-group">
                                    <label>Description ( Main Post )</label>
                                <textarea name="details_description" class="form-control my-editor" rows="9">{{ $blogDetail->details_description }}</textarea>
                            ...
                            <div class="form-group">
                                <label class="control-label">Category </label>
                                    <select name="category_id" id="e2"class="populate placeholder">
                                        ...
                                        <option value="{{ $categoryDetail->id }}" {{ $blogDetail->category_id == $categoryDetail->id ? "selected" : " " }}>{{ $categoryDetail->category_name }}</option>
                                        @endforeach
                                    </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                    <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                        <img src="{{ asset('') }}{{ $blogDetail->feature_image }}" alt="" />
                                    </div>
                                    ...
                                    <div>
                                                   ...
                                                   <input type="file" class="default" name="feature_image" accept="image/*"/>
                                                   <input type="hidden"" name="feature_image_link" value="{{ $blogDetail->feature_image }}"/>
                                                   </span>
