...
{{ csrf_field() }}
                    <div class="form-group">
                        ...
                        <input type="text" name="category_name" class="form-control" placeholder="Give a category name." maxlength="50" required>

                    </div>
                    <div class="form-group">
                        <label>Category Slug</label>
                        <input type="text" name="category_slug" class="form-control" placeholder="Give a category slug. Ex: category-slug." maxlength="50" required>

                    </div>
                    <div class="form-group">
                        <label>Short Description ( For SEO )</label>
                        <textarea class="form-control" name="category_description" rows="3" placeholder="Short Description" maxlength="200"></textarea>
                    </div>
                    <div class="form-group">
