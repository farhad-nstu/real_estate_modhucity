    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <div class="position-center">
                <div class="col-md-12">
                    <form role="form" action="{{ route('career-save') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                                                ...
                                                <textarea class="form-control ckeditor" name="message" placeholder="Some Description" required></textarea>
                            </div>
                            <div class="form-group">
