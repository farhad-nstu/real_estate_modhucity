...
@section('title', 'Company Director Message')
@section('css')
    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <div class="position-center">
                <div class="col-md-12">
                    <form role="form" action="{{ route('company-message') }}" method="post">
                        {{ csrf_field() }}
                            <div class="prf-contacts sttng">
                                <h2>Company Director Message</h2>
                            </div>
                            <div class="form-group">
                                    <label>Messages of</label>
                                        <select name="position" class="form-control" required> 
                                            <option selected disabled>Select Position</option>
                                        <option value="chairman">Chairman Message</option>
                                        <option value="md">Managing Director Message</option>
                                         </select>
                                    </div>
                        <div class="form-group">
                            <label>Name</label>
                        ...
                        <div class="form-group">
                                                <label>Message</label>
                                                <textarea class="form-control ckeditor" name="cm_message" placeholder="Some Description" required></textarea>
                            </div>
                        <div class="form-group">
                        ...
                        <button type="submit" name="btn" class="btn btn-info">Save Info</button>
                    </form>
                </div>
            </div>
