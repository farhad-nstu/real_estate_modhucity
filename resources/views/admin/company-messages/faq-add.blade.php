    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <div class="position-center">
                <div class="col-md-12">
                    <form role="form" action="{{ route('save-faq') }}" method="post"
                        enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="form-group">
                                <div class="prf-contacts sttng">
                                    <h2 class="text-capitalize">Add frequently asked questions</h2>
                                </div>
                            <label>Question</label>
                            <input type="text" class="form-control" name="question" placeholder="Ex: Who are you?" required>
                        </div>

                        <div class="form-group">
                            <label>Answer</label>
                            <textarea name="answer" class="form-control ckeditor" placeholder="Ex: I am a Robot!" required></textarea>
                        ...
                        <button type="submit" name="btn" class="btn btn-info">Save Question</button>
                    </form>
                </div>
            </div>
