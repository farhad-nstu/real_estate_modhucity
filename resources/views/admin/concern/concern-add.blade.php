    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <div class="position-center">
                <div class="col-md-12">
                    <form role="form" action="{{ route('concern-save') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" name="concern_url" class="form-control">
                        ...
                        <div class="form-group">
                                                ...
                                                <textarea class="form-control ckeditor" name="concern_description" placeholder="Some Description" required></textarea>
                            </div>
                        <div class="form-group">
