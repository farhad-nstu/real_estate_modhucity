    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <div class="position-center">
                <div class="col-md-12">
                    <form role="form" action="{{ route('concern-update') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="form-group">
                            ...
                            <input type="text" name="concern_title" class="form-control" value="{{ $concern->concern_title }}" required>
                            <input type="hidden" name="id" value="{{ $concern->id }}">
                        </div>
                        <div class="form-group">
                            <label>Concern Url</label>
                            <input type="url" name="concern_url" value="{{ $concern->concern_url }}" class="form-control">

                        </div>
                        <div class="form-group">
                                <label class="control-label">Concern Image</label>
                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                    <div class="fileupload-new thumbnail" style="width: 276px; height: 256px;">
                                        <img src="{{ asset('') }}{{ $concern->concern_photo }}">
                                    </div>
                                    ...
                                    <div>
                                                   ...
                                                   <input type="file" class="default" name="concern_photo" accept="image/*"/>
                                                   <input type="hidden" value="{{ $concern->concern_photo }}" name="concern_photo_url">
                                                   </span>
                        ...
                        <div class="form-group">
                                                ...
                                                <textarea class="form-control ckeditor" name="concern_description" placeholder="Some Description" required>{{ $concern->concern_description }}</textarea>
                            </div>
                        <div class="form-group">
