    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <div class="position-center">
                ...
                <form role="form" action="{{ route('contact-info') }}" method="post">
                        {{ csrf_field() }}
                        <input type="hidden"  value="{{ $info->id }}" name="id">
                        <div class="form-group">
                            <label>Phone 1</label>
                        <input type="text" name="phone_1" class="form-control" value="{{ $info->phone_1 }}" placeholder="Add Phone 1">
                        </div>
                        <div class="form-group">
                            <label>Phone 2</label>
                            <input type="text" name="phone_2" class="form-control"  value="{{ $info->phone_2 }}" placeholder="Add Phone 2">
                        </div>
                        <div class="form-group">
                            <label>Corporate Office</label>
                            <textarea name="corporate_office" class="form-control" placeholder="Add Corporate Office Address">{{ $info->corporate_office }}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Office Address</label>
                            <textarea name="office_address" class="form-control" placeholder="Add Office Address">{{ $info->office_address }}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Email Address</label>
                            <input type="email" name="email" class="form-control"  value="{{ $info->email }}" placeholder="Add Email Address">
                        </div>
                        <div class="form-group">
                            <label>Linkedin</label>
                            <input type="text" name="linkedin" class="form-control"  value="{{ $info->linkedin }}" placeholder="Linkedin">
                        </div>
                        <div class="form-group">
                            <label>Facebook</label>
                            <input type="text" name="facebook" class="form-control"  value="{{ $info->facebook }}" placeholder="Facebook">
                        </div>
                        <div class="form-group">
                            <label>Twitter</label>
                            <input type="text" name="twitter" class="form-control"  value="{{ $info->twitter }}" placeholder="Twitter">
                        </div>     
                        <div class="form-group">
                            <label>Whatsapp</label>
                            <input type="text" name="whatsapp" class="form-control"  value="{{ $info->whatsapp }}" placeholder="Whatsapp">
                        </div>
                        <div class="form-group">
                            <label>Youtube</label>
                            <input type="text" name="youtube" class="form-control"  value="{{ $info->youtube }}" placeholder="Youtube">
                        </div>
