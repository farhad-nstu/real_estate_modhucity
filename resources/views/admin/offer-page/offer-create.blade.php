...
<div class="row">
    <section class="panel">
        <header class="panel-heading text-center"><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
           Add Offer or Promotion
        </header>
        <div class="panel-body">
            <div class="position-center">
                <div class="col-md-12">
                    <form role="form" action="{{ route('offer-save') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                            <div class="prf-contacts sttng">
                                <h2>Project for Promotion</h2>
                            </div>
                            <div class="form-group">
                                    <label>Project Name</label>
                                        <select name="offer_project_url" class="form-control" required> 
                                            <option selected disabled>Select a project</option>
                                            <option value="0">For All Project</option>
                                      @foreach($projectLists as $project)
                                      <option value="{{ $project->project_slug }}">{{ $project->project_name }}</option>
                                      @endforeach
                                         </select>
                                    </div>
                        <div class="form-group">
                            ...
                            <input type="text" name="offer_title" class="form-control" required>
                                ...
                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                    ...
                                    <div>
                                                   ...
                                                   <input type="file" class="default" name="offer_image" accept="image/*"/>
                                                   </span>

                                    </div>
                                </div> <div class="form-group">
                                <label class="control-label">FronEnd Image Upload</label>
                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                    <div class="fileupload-new thumbnail" style="width: 276px; height: 256px;">
                                    </div>
                                    <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                                    <div>
                                                   ...
                                                   <span class="fileupload-new"><i class="fa fa-paper-clip"></i> Select image</span>
                                                   <span class="fileupload-exists"><i class="fa fa-undo"></i> Change</span>
                                                   <input type="file" class="default" name="offer_frontEnd_image" accept="image/*"/>
                                                   </span>
                        ...
                        <div class="form-group">
                                                ...
                                                <textarea class="form-control ckeditor" name="offer_description" placeholder="Some Description" required></textarea>
                            </div>
                        <div class="form-group">
