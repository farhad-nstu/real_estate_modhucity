    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <div class="position-center">
                <div class="col-md-12">
                    <form role="form" action="{{ route('save-brochure') }}" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <label>Project Brochure ( PDF only )</label>
                            <input type="file" name="brochure" class="form-control" accept=".pdf">

                        </div>
                        
                        <button type="submit" name="btn" class="btn btn-info">Add to Project</button>
                    </form>
                </div>
            </div>
