    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <div class="position-center">
                <div class="col-md-12">
                    <form role="form" class="form-horizontal" action="{{ route('image-save') }}" method="POST" enctype="multipart/form-data">
                                                {{ csrf_field() }}
                                                    ...
                                                    <div class="prf-contacts sttng">
                                                        <h2>Add Gallary Image</h2>
                                                         ...
                                                         <div class="form-group">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <input type="file" name="image" class="file-pos form-control" accept="image/*" required>
                                                                </div>
                                                        </div>
                                                        <div class="prf-contacts sttng">
