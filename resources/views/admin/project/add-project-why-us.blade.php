...
@section('title', 'Add Project Why Choose us')
@section('css')
    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <div class="position-center">
                <div class="col-md-12">
                    <form role="form" action="{{ route('add-project-why-choose') }}" method="post">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <label>Title</label>
                            <input type="text" name="why_choose_title" class="form-control" required>

                        </div>
                        <div class="form-group">
                                                <label>Description</label>
                                                <textarea class="form-control ckeditor" name="why_choose_description" placeholder="Some Description" required></textarea>
                            </div>
                        <div class="form-group">
