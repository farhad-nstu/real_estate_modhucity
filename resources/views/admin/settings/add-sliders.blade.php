    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <div class="position-center">
                <div class="col-md-12">
                    <form role="form" action="{{ route('sliders-add') }}" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" name="slider_image_link" class="form-control" placeholder="Sliders Link" required>
                        </div>
                        <div class="form-group">
                            <label>Slider Position</label>
                            <input type="number" name="slider_image_serial" class="form-control" placeholder="Serial/Position" required>
                        </div>
                        <div class="form-group">
