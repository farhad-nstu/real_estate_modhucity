...
@section('content')
  ...
  Your browser does not support HTML5 video.
    ...
    <!--<div class="stick1">
    <a href="#"><img src="{{ asset('') }}assets/blog/img/awwwards.png" ></a>
    </div>-->
...
<!--<h2 class="artd"><span>About Us</span></h2>-->
     ...
     <section class="mobi-inn">
        <img src="{{ asset('') }}assets/blog/image/atria.jpg"  style="width:100%;"/>
    </section>
...
<script type='text/javascript'>
  ...
  <ul class="nav nav-tabs inner-tabs " role="tablist" style="margin-top:15px;">
                                        <li role="presentation" class="active" style="margin:auto;"> <a href="#home" aria-controls="home" role="tab" data-toggle="tab" class="active"><i class="fa profile1-fa" aria-hidden="true"></i> {{ $data['category_name'] }}</a></li>
                            ...
                            <div class="col-sm-6 col-12">
                                <div class="blog-box-layout1">
                                    ...
                                    <div class="item-content">
                                        <ul class="entry-meta">
                                        <li><a href="#"><i class="fas fa-clock"></i>{{ $blog->created_at->format('M d, Y')}}</a></li>
