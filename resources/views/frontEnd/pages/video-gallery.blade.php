...
@foreach($videoDetails as $video)
  ...
  <div class="col-lg-4 col-md-12 mb-4">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body mb-0 p-0">
            ...
            <div class="embed-responsive embed-responsive-16by9 z-depth-1-half">
              <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/{{ $video->video_link }}" allowfullscreen></iframe>
            </div>
    ...
    <a><iframe class="embed-responsive-item" src="https://www.youtube.com/embed/{{ $video->video_link }}" data-toggle="modal" data-target="#modal1" allowfullscreen></iframe></a>
